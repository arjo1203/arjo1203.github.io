...
NerdBoard.Tools = window.onload = (function() {
                ...
                if (paperEvent.event.type == 'mousedown') {
                    ...
                    if (paperEvent.event.which == 1) {
                        ...
                        if (hit) {
                            ...
                            //console.log(hitItem);
                            //console.log(hitItemParent);
                            //console.log(hitItamParentName);
    ...
    wbTools.tools.draw.onDoubleClick = function(paperEvent) {
    ...
    wbTools.resizeBg = function() {
        var bg = paper.project.layers[0].children[0];
