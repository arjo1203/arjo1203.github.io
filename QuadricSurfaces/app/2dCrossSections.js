...
function twoInit(){
    ...
    twoCamera = new THREE.PerspectiveCamera(45, leftView[0].clientWidth / (leftView[0].clientHeight *.3), 1, 1000);
    twoCamera.position.set(0, 0, 50);
    twoCamera.lookAt(threeScene.position);
