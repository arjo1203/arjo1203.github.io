...
function passAngleToU(angle12, angle13, angle14, angle23, angle24, angle34){
    var results = [
        [
            pasredU[0](angle12, angle13, angle14),
            pasredU[1](angle12, angle13, angle14),
            pasredU[2](angle13, angle14),
            pasredU[3](angle14)
        ],
        [
            pasredU[4](angle12, angle13, angle14, angle23, angle24),
            pasredU[5](angle12, angle13, angle14, angle23, angle24),
            pasredU[6](angle13, angle14, angle23, angle24),
            pasredU[7](angle14, angle24)
        ],
        [
            pasredU[8](angle12, angle13, angle14, angle23, angle24, angle34),
            pasredU[9](angle12, angle13, angle14, angle23, angle24, angle34),
            pasredU[10](angle13, angle14, angle23, angle24, angle34),
            pasredU[11](angle14, angle24, angle34)
        ],
        [
            pasredU[12](angle12, angle13, angle14, angle23, angle24, angle34),
            pasredU[13](angle12, angle13, angle14, angle23, angle24, angle34),
            pasredU[14](angle13, angle14, angle23, angle24, angle34),
            pasredU[15](angle14, angle24, angle34)
        ]
    ];
